...
- Windows 版会检查浏览器标签页（Chrome/Edge 等 Chromium 浏览器），网页在后台标签页时不会重复打开；
...
| Windows 网页关闭后不自动重开 | 后台标签检测（UI Automation）仅支持 Chrome/Edge 等 Chromium 浏览器；使用 Firefox 等浏览器时请手动重开 |
